...
public class YoutubePlayerLivestream : MonoBehaviour {
    ...
    IEnumerator DownloadYoutubeUrl(string url, System.Action<string> callback)
    {
        ...
        request.SetRequestHeader("User-Agent", "Mozilla / 5.0(Linux; Android 8.0.0; SM - G960F Build / R16NW) AppleWebKit / 537.36(KHTML, like Gecko) Chrome / 62.0.3202.84 Mobile Safari/ 537.36");
